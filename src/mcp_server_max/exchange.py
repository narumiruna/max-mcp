...
class MAXExchange:
    ...
    async def get_ticker(self, symbol: str) -> Ticker:
        ...
        Args:
            symbol (str): The market symbol to get the ticker for.
        Returns:
            Ticker: The latest ticker of the specified market.
        """
        resp = await self.client.make_request("/api/v3/ticker", params={"market": symbol})
        return Ticker.model_validate(resp | {"market": symbol})
